...
/**
  ...
  @method process
*/
Queue.prototype.process = function(name, concurrency, handler, method) {
  ...
  this.setHandler(name, handler, method);
...
Queue.prototype.setHandler = function(name, handler, handlerMethod) {
  if (!handler) {
  ...
  if (typeof handler === 'string') {
    ...
    this.handlers[name] = sandbox(handler, this.childPool, handlerMethod).bind(
      this
    );
  } else {
